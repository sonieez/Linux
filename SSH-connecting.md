...
<h2>Step 3. Getting IP from</h2>

`ip a` --> finding IP address
...
<!--
<h2>Step 4. Connecting with Public Key</h2>
...
6) Opening Red hat bash.
7) Makin directory to save the key - `mkdir .ssh`
